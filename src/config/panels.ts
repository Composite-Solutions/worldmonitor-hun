...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  'world-clock': { name: 'World Clock', enabled: true, priority: 1 },
  ...
  // --- News (Hungary first) ---
  hungary: { name: 'Hungary News', enabled: true, priority: 1 },
  us: { name: 'USA News', enabled: true, priority: 1 },
  europe: { name: 'Europe News', enabled: true, priority: 1 },
  politics: { name: 'World News', enabled: true, priority: 1 },
  ai: { name: 'AI News', enabled: true, priority: 1 },
  // --- Intelligence ---
  insights: { name: 'AI Insights', enabled: true, priority: 1 },
  thinktanks: { name: 'Think Tanks', enabled: false, priority: 2 },
  gov: { name: 'Government (Hungary & USA)', enabled: false, priority: 2 },
  ...
  'energy-complex': { name: 'Energy Complex', enabled: false, priority: 2 },
  energy: { name: 'Energy & Resources', enabled: false, priority: 2 },
  commodities: { name: 'Metals & Materials', enabled: false, priority: 2 },
  'supply-chain': { name: 'Supply Chain', enabled: false, priority: 2, ...(_desktop && { premium: 'enhanced' as const }) },
  // --- Macro & Trade ---
  economic: { name: 'Macro Stress', enabled: false, priority: 2 },
  ...
  // --- Strategic & Intel ---
  'strategic-risk': { name: 'Strategic Risk Overview', enabled: false, priority: 2, ...(_desktop && { premium: 'enhanced' as const }) },
  intel: { name: 'Intel Feed', enabled: false, priority: 2 },
  cii: { name: 'Country Instability', enabled: false, priority: 2, ...(_desktop && { premium: 'enhanced' as const }) },
  'gdelt-intel': { name: 'Live Intelligence', enabled: false, priority: 2, ...(_desktop && { premium: 'enhanced' as const }) },
  'ucdp-events': { name: 'Armed Conflict Events', enabled: false, priority: 2 },
  ...
  'strategic-posture': { name: 'AI Strategic Posture', enabled: false, priority: 2 },
  forecast: { name: 'AI Forecasts', enabled: false, priority: 2, ...(_desktop && { premium: 'locked' as const }) },
  cascade: { name: 'Infrastructure Cascade', enabled: false, priority: 2 },
  ...
  asia: { name: 'Asia-Pacific', enabled: false, priority: 2 },
...
export const PANEL_CATEGORY_MAP: Record<string, { labelKey: string; panelKeys: string[]; variants?: string[] }> = {
  ...
  regionalNews: {
    ...
    panelKeys: ['hungary', 'politics', 'us', 'europe', 'middleeast', 'africa', 'latam', 'asia'],
  },
  marketsFinance: {
