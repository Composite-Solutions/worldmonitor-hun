...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  gov: { name: 'Government (Hungary & USA)', enabled: true, priority: 1 },
  ...
  'ucdp-events': { name: 'Armed Conflict Events', enabled: true, priority: 1 },
  'radiation-watch': { name: 'Radiation Watch', enabled: true, priority: 1 },
  'telegram-intel': { name: 'Telegram Intel', enabled: true, priority: 1, ...(_desktop && { premium: 'locked' as const }) },
  'airline-intel': { name: 'Airline Intelligence', enabled: true, priority: 1 },
